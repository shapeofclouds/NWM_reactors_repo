##Sexuality Filter and Summation####
#  
source("./source_files/SeriesFilter.R", local = TRUE)

sexuality_region <- reactive ({
  
  EDI_char <- EDI_long %>%
    filter(CharacteristicGroup == "Sexuality") #this could be exported to SeriesFilter
