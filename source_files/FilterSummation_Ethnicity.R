##Ethnicity Filter and Summation####
#  
source("./source_files/SeriesFilter.R", local = TRUE)


ethnicity_region <- reactive ({
  
  EDI_char <- EDI_long %>%
    filter(CharacteristicGroup == "Ethnicity") #this could be exported to SeriesFilter
